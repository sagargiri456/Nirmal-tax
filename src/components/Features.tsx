...
import { Shield, Eye, DollarSign, Clock, Award, ChevronLeft, ChevronRight } from 'lucide-react';
                ...
                return (
                  ...
                  >
                    <div className="bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 lg:p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-1 sm:hover:-translate-y-2 h-full">
                      <div className="bg-white/20 w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-4 md:mb-5 lg:mb-6">
