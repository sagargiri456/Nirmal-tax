        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className={`space-y-4 sm:space-y-8 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8">
              ...
              <div className="lg:col-span-4">
                <div className="grid grid-cols-2 gap-3 sm:gap-5 h-full">
                  <div className="group bg-white rounded-lg sm:rounded-2xl p-3 sm:p-6 border-2 border-gray-100 hover:border-[#6958c2]/40 hover:shadow-xl transition-all duration-500 hover:-translate-y-1 text-center">
                    <div className="w-10 h-10 sm:w-16 sm:h-16 bg-gradient-to-br from-[#6958c2] to-[#5a4ab3] rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 mx-auto group-hover:scale-110 transition-all duration-500 shadow-lg p-1 sm:p-2">
                      <img src={accountantIcon} alt="Accountants" className="w-full h-full object-contain" />
                    </div>
                    <div className="text-lg sm:text-3xl md:text-4xl font-display font-normal mb-1 sm:mb-2 text-[#011441]">10</div>
                    <div className="text-xs sm:text-sm text-gray-600 font-medium">Dedicated Accountants</div>
                  </div>

                  <div className="group bg-white rounded-lg sm:rounded-2xl p-3 sm:p-6 border-2 border-gray-100 hover:border-orange-400/40 hover:shadow-xl transition-all duration-500 hover:-translate-y-1 text-center">
                    <div className="w-10 h-10 sm:w-16 sm:h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 mx-auto group-hover:scale-110 transition-all duration-500 shadow-lg p-1 sm:p-2">
                      <img src={caseStudyIcon} alt="Cases" className="w-full h-full object-contain" />
                    </div>
                    <div className="text-lg sm:text-3xl md:text-4xl font-display font-normal mb-1 sm:mb-2 text-[#011441]">50+</div>
                    <div className="text-xs sm:text-sm text-gray-600 font-medium">Cases Completed</div>
                  </div>

                  <div className="group bg-white rounded-lg sm:rounded-2xl p-3 sm:p-6 border-2 border-gray-100 hover:border-green-400/40 hover:shadow-xl transition-all duration-500 hover:-translate-y-1 text-center">
                    <div className="w-10 h-10 sm:w-16 sm:h-16 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 mx-auto group-hover:scale-110 transition-all duration-500 shadow-lg p-1 sm:p-2">
                      <img src={businessEthicsIcon} alt="Transparency" className="w-full h-full object-contain" />
                    </div>
                    <div className="text-lg sm:text-3xl md:text-4xl font-display font-normal mb-1 sm:mb-2 text-[#011441]">100%</div>
                    <div className="text-xs sm:text-sm text-gray-600 font-medium">Transparency</div>
                  </div>

                  <div className="group bg-white rounded-lg sm:rounded-2xl p-3 sm:p-6 border-2 border-gray-100 hover:border-blue-400/40 hover:shadow-xl transition-all duration-500 hover:-translate-y-1 text-center">
                    <div className="w-10 h-10 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 mx-auto group-hover:scale-110 transition-all duration-500 shadow-lg p-1 sm:p-2">
                      <img src={establishmentIcon} alt="Established" className="w-full h-full object-contain" />
                    </div>
                    <div className="text-lg sm:text-3xl md:text-4xl font-display font-normal mb-1 sm:mb-2 text-[#011441]">2024</div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6">
              <div className="group bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl border-2 border-gray-100 hover:border-[#6958c2]/40 hover:shadow-[#6958c2]/20 transition-all duration-500">
                <div className="bg-gradient-to-br from-[#6958c2] to-[#011441] p-2 sm:p-3 rounded-lg sm:rounded-xl w-fit mb-3 sm:mb-4 shadow-lg group-hover:scale-110 transition-all duration-500">
                  <img src={targetIcon} alt="Vision" className="w-5 h-5 sm:w-7 sm:h-7 object-contain" />
                </div>
                <h3 className="text-sm sm:text-base md:text-lg font-bold text-[#011441] mb-2 sm:mb-3">Our Vision</h3>
              ...
              <div className="group bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl border-2 border-gray-100 hover:border-[#6958c2]/40 hover:shadow-[#6958c2]/20 transition-all duration-500">
                <div className="bg-gradient-to-br from-[#6958c2] to-[#011441] p-2 sm:p-3 rounded-lg sm:rounded-xl w-fit mb-3 sm:mb-4 shadow-lg group-hover:scale-110 transition-all duration-500">
                  <img src={rocketIcon} alt="Mission" className="w-5 h-5 sm:w-7 sm:h-7 object-contain" />
                </div>
                <h3 className="text-sm sm:text-base md:text-lg font-bold text-[#011441] mb-2 sm:mb-3">Our Mission</h3>
                <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
              ...
              <div className="group bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl border-2 border-gray-100">
                <div className="flex items-center gap-2 mb-3 sm:mb-4">
                  <div className="bg-gradient-to-br from-[#6958c2] to-[#011441] p-2 rounded-lg sm:rounded-xl shadow-lg">
                    <img src={medalIcon} alt="Medal" className="w-4 h-4 sm:w-6 sm:h-6 object-contain" />
                  </div>
                  <h4 className="text-sm sm:text-base md:text-lg font-bold text-[#011441]">Our Motto</h4>
                </div>
                <p className="text-xs sm:text-sm font-display font-normal italic leading-relaxed mb-3 sm:mb-4 text-gray-700">
                  "Pure in Purpose. Precise in Practice. Perfect in Performance"
                </p>
                <div className="flex items-center gap-2 text-gray-600">
                  <Calendar className="text-[#6958c2]" size={14} />
